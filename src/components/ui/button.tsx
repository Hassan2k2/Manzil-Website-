  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold font-display ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-coral text-primary-foreground hover:bg-coral-dark shadow-glow hover:shadow-elevated transform hover:scale-105",
        heroOutline: "border-2 border-coral bg-transparent text-coral hover:bg-coral hover:text-primary-foreground",
        teal: "bg-teal text-secondary-foreground hover:bg-teal-dark shadow-card hover:shadow-elevated",
        amber: "bg-amber text-accent-foreground hover:bg-amber-light shadow-card",
