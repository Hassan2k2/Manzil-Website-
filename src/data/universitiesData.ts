...
export const universities: University[] = [
  ...
  // Highly Selective US Universities
  {
    ...
    scholarships: [
      { name: "Penn Grant", coverage: "Up to full cost of attendance", eligibility: "Demonstrated financial need; domestic and Canadian/Mexican students", deadline: "Early Decision/Regular Decision deadlines", applyLink: "https://srfs.upenn.edu/financial-aid/grants-and-scholarships" },
      { name: "Named/Endowed Scholarships", coverage: "Varies", eligibility: "Based on donor criteria (e.g. hometown, major) but awarded strictly based on financial need", deadline: "No separate application", applyLink: "https://srfs.upenn.edu/financial-aid/grants-and-scholarships" },
      { name: "Mayor's Scholarship", coverage: "Varies", eligibility: "Highly qualified students from Philadelphia public/charter schools with financial need", deadline: "Regular Decision deadline", applyLink: "https://srfs.upenn.edu/financial-aid/grants-and-scholarships" },
      { name: "Federal Pell Grant", coverage: "Up to ~$7,395/year", eligibility: "High financial need; U.S. citizens/eligible noncitizens", applyLink: "https://srfs.upenn.edu/financial-aid/grants-and-scholarships" },
      { name: "PHEAA State Grant", coverage: "Varies", eligibility: "Pennsylvania residents with financial need", deadline: "May 1", applyLink: "https://srfs.upenn.edu/financial-aid/grants-and-scholarships" },
    ],
  ...
  },
  {
    ...
    scholarships: [
      ...
      { name: "USC University Grant", coverage: "Varies (Free tuition for <$80K income)", eligibility: "Meets 100% of demonstrated need for domestic students", deadline: "Regular Decision deadline", applyLink: "https://financialaid.usc.edu/undergraduates/prospective/scholarships.html" },
    ],
  ...
  },
  {
    ...
    scholarships: [
      { name: "Go Blue Guarantee", coverage: "Free Tuition for 4 years", eligibility: "In-state students with family incomes of $75,000 or under and assets below $75,000", applyLink: "https://finaid.umich.edu/types-aid/scholarships-grants" },
      { name: "Stamps Scholarship", coverage: "Full cost of attendance + $10,000 enrichment fund", eligibility: "Top-tier incoming freshmen demonstrating leadership, perseverance, and service", deadline: "No separate application", applyLink: "https://finaid.umich.edu/types-aid/scholarships-grants" },
      { name: "HAIL Scholarship", coverage: "Full tuition and fees", eligibility: "High-achieving, low-income students from Michigan", applyLink: "https://finaid.umich.edu/types-aid/scholarships-grants" },
    ],
  ...
  // Most Selective UK Universities
  {
    ...
    scholarships: [
      ...
      { name: "Reach Oxford Scholarships", coverage: "Tuition fees + living expenses + flights", eligibility: "Students from low-income countries who cannot study in their own countries", deadline: "February", applyLink: "https://www.ox.ac.uk/admissions/undergraduate/fees-and-funding/reach-oxford-scholarship/" },
  ...
  },
  {
    ...
    scholarships: [
      ...
      { name: "Cambridge Trust Scholarships", coverage: "Varies (up to full tuition/maintenance)", eligibility: "International/Overseas students demonstrating financial need and outstanding merit", deadline: "Varies (Often requires college nomination)", applyLink: "https://www.cambridge.org.uk/admissions/undergraduate/fees-and-finance" },
    ],
  ...
  },
  {
    ...
    scholarships: [
      ...
      { name: "Stamps Scholarship", coverage: "Full cost of attendance + $10,000 enrichment fund", eligibility: "Top-tier incoming freshmen demonstrating leadership, perseverance, and service", deadline: "No separate application", applyLink: "https://finaid.umich.edu/types-aid/scholarships-grants" },
      { name: "HAIL Scholarship", coverage: "Full tuition and fees", eligibility: "High-achieving, low-income students from Michigan", applyLink: "https://finaid.umich.edu/types-aid/scholarships-grants" },
      { name: "Shipman Scholarship", coverage: "$32,000 to full out-of-state tuition", eligibility: "Outstanding academic and personal achievement; highly selective", deadline: "No separate application", applyLink: "https://finaid.umich.edu/types-aid/scholarships-grants" },
    ],
    website: "https://umich.edu",
    applyLink: "https://admissions.umich.edu/apply",
    logo: "https://logo.clearbit.com/umich.edu",
